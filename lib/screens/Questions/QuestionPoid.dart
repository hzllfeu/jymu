...
class QuestionPoid extends StatefulWidget {

  final int sexe;

  const QuestionPoid({super.key, required this.sexe});

  static String routeName = "/";

  @override
  State<QuestionPoid> createState() => _QuestionPoidState();
}

class _QuestionPoidState extends State<QuestionPoid> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  Image.asset("assets/images/emoji_pinned.png", height: 32,),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 25),
                    child: Text(
                      "Vous voulez prendre ou perdre combien de kilos ?",
                            ...
                            children: [
                              Padding(
                                ...
                                child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        "Vous souhaitez perdre $ob kilos",
                              ...
                              GestureDetector(
                                onTapUp: (t) {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => QuestionObj(sexe: widget.sexe, poidobj: ob,),
                                    ),
                                  );
                                },
                                child: Padding(
