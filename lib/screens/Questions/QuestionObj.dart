...
class QuestionObj extends StatefulWidget {
  ...
  const QuestionObj({super.key, required this.sexe, required this.poidobj});

  static String routeName = "/";

  @override
  State<QuestionObj> createState() => _QuestionObjState();
}
                                  ...
                                  GestureDetector(
                                    onTapUp: (t) {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => QuestionTaille(sexe: widget.sexe, poidobj: widget.poidobj, obj: 0,),
                                        ),
                                      );
                                    },
                                    child: Padding(
                                  ...
                                  GestureDetector(
                                    onTapUp: (t) {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => QuestionTaille(sexe: widget.sexe, poidobj: widget.poidobj, obj: 1,),
                                        ),
                                      );
                                    },
                                    child: Padding(
