...
class Paiements extends StatefulWidget {
  ...
  @override
  State<Paiements> createState() => _PaiementState();
}

class _PaiementState extends State<Paiements> {

  double calculateIMC() {
    double heightInMeters = 160 / 100.0;
    double imc = 69 / (heightInMeters * heightInMeters);
